      ...
      <div class="row">
        <div class="col-md-12">
          ...
          if (isset($_GET['id'])) {
            ...
            $pembelian = mysqli_query($koneksi, "SELECT * FROM pembelian WHERE id_pembelian='$id_pembelian' AND id_pelanggan='$id_pelanggan' ");
              ...
              <div class="card mb-2 mt-6">
                <div class="card-body">
                  ...
                  if ($array_pembelian['status'] == "Dikirim" || $array_pembelian['status'] == "Selesai") { ?>
                    <p class="text-muted ml-3 label-paket" style="font-size: 12px; margin-bottom: -4px; margin-top: -10px;">Resi Pengiriman : <?php echo $array_pembelian['resi_pengiriman']; ?></p>
                  <?php }
                  ?>
                </div>
              </div>     
                    ...
                    <div class="card-body">
                      ...
                      if ($array_pembelian['status'] == "Belum Bayar" || $array_pembelian['status'] == "Pembayaran Gagal") { ?>
                        <div class="d-flex justify-content-end">
                          <button type="button" name="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modalUpload"><i class="fa fa-money-bill"></i> Lakukan Pembayaran <?php if ($array_pembelian['status'] == "Pembayaran Gagal") { echo "Ulang"; } ?></button>
                        </div>
                      <?php } ?>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="upload_pembayaran.php" method="post" enctype="multipart/form-data">
            ...
            <button type="submit" name="submit" class="btn btn-danger float-right btn-sm"><i class="fa fa-upload"></i> Upload</button>
  ...
  <script type="text/javascript">
    ...
    if (isset($_GET['pesan'])) {
      if ($_GET['pesan'] == "berhasil") { ?>
        Swal.fire({
          title: "Berhasil",
          text: "Bukti Pembayaran Berhasil Di Upload",
          icon: "success"
        })
